...
const MerchStore = () => {
  ...
  const featuredProduct = {
    ...
    price: 149.99,
    description: "Limited edition collector's set with exclusive merch, behind-the-scenes footage, and signed memorabilia from the crew.",
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-3xl md:text-4xl text-white font-laser mb-6">FEATURED GEAR</h2>
        ...
        <div className="relative w-full rounded-xl overflow-hidden backdrop-blur-sm bg-white/5 border border-white/10">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-1/2 aspect-square md:aspect-auto relative">
              <img
                src={featuredProduct.image || "https://placehold.co/600x600/333/fff?text=Featured+Product"}
            ...
            <div className="md:w-1/2 p-6 md:p-8 flex flex-col justify-between">
              <div>
                <h3 className="text-2xl md:text-3xl text-white font-bold font-tektur">{featuredProduct.title}</h3>
                <p className="text-white/80 mt-3 mb-4 text-lg">{featuredProduct.description}</p>
      ...
      <motion.div
        ...
        variants={itemVariants}
      >
        <h2 className="text-2xl md:text-3xl text-white font-laser mb-6">SHOP BY CATEGORY</h2>
          ...
          {categories.map((category, index) => (
            ...
            >
              ...
              <div className="absolute inset-0">
                <img
                  src={category.image || `https://placehold.co/400x200/222/fff?text=${category.name}`}
                  alt={category.name}
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-4 bg-black/30">
                ...
                <h3 className="text-xl text-white font-bold font-tektur">{category.name}</h3>
      ...
      <motion.div
        ...
        variants={itemVariants}
      >
        <h2 className="text-2xl md:text-3xl text-white font-laser mb-6">BEST SELLERS</h2>
          ...
          {products.filter(product => product.bestseller).map((product, index) => (
            ...
            >
              ...
              <div className="aspect-square overflow-hidden">
                <img
                  src={product.image || `https://placehold.co/300x300/222/fff?text=${product.name}`}
                  alt={product.name}
              ...
              {/* Product Info */}
              <div className="p-4">
                <h3 className="text-white font-medium font-tektur line-clamp-1">{product.name}</h3>
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl md:text-3xl text-white font-laser">ALL PRODUCTS</h2>
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="md:flex-1">
            <h3 className="text-2xl text-white font-bold font-tektur mb-2">JOIN THE CREW</h3>
            <p className="text-white/80">
              Sign up for our newsletter to get early access to drops, exclusive discounts, and behind-the-scenes content.
            </p>
          </div>
