...
const MediaShowcase = () => {
  ...
  const channelInfo = {
    ...
    subscribers: "1.5M",
    description:
      "The wildest ride culture show on YouTube. We showcase street culture, extreme sports, and everything in between. From dirt bikes in the city to ATVs on the highway, we bring you the most authentic look at ride life across America.",
    foundedIn: "2020",
    uploads: "250+",
      ...
      <motion.div className="w-full mb-12" variants={itemVariants}>
        ...
        <div className="relative aspect-video w-full rounded-xl overflow-hidden group">
          ...
          <div className="absolute inset-0 bg-black">
            <img
              src={
                ...
                "https://placehold.co/1920x1080/333/fff?text=What%27s+Good+America"
              }
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4 md:p-6">
            <h3 className="text-xl md:text-2xl text-white font-semibold font-tektur">
              {featuredVideo.title}
            </h3>
            <p className="text-white/80 mt-2 max-w-3xl line-clamp-2">
          ...
          {shorts.map((short, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-3">
                <h3 className="text-white text-sm md:text-base font-medium line-clamp-1 font-tektur">
                  {short.title}
                </h3>
